...
<head>
    ...
    <title>Vista Previa - Reporte de Conciliación</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="header-bar">
            <h1>📄 Vista Previa - Reporte de Conciliación</h1>
        ...
        <div class="content">
            ...
            <table>
                <tr>
                    ...
                    <td class="info-value" style="font-size: 20px;">${{ $data['enviar_sucursal']['total_ventas'] }}</td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" rowspan="4" class="parador-title">{{ $metadata['sucursal'] }}</td>
                </tr>
                <tr>
