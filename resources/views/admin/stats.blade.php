                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span
                                        class="font-semibold text-blue-600">{{ $periodMetrics[$key]['converted_leads'] }}</span>
                                </div>
                                <div class="flex justify-between border-t pt-2 mt-2">
                                    <span class="text-gray-600">Ingresos:</span>
                                    <span
                                        class="font-semibold text-green-600">${{ number_format($periodMetrics[$key]['revenue']) }}</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
