        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="text-2xl font-bold">{{ number_format($conversionMetrics['lead_conversion_rate'], 1) }}%
                    </div>
                    ...
                    @foreach($activityMetrics['recent_activities']->take(10) as $activity)
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($activity->created_at)->diffForHumans() }}
                                </p>
                            </div>
                        </div>
                    @endforeach
