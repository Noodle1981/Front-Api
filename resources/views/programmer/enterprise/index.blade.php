                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    {{-- Edit Link --}}
                                    <a href="{{ route('programmer.enterprise.edit', $api->id) }}" class="text-gray-400 hover:text-aurora-cyan transition transform hover:scale-110" title="Editar Configuración">
                                        <i class="fas fa-cog text-lg"></i>
                                    </a>
                                    
                                    <form action="{{ route('programmer.enterprise.destroy', $api->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de eliminar esta integración?');">
                                        @csrf
                                        @method('DELETE')
